<?php
    ...
    ?>
       ...
       <!--<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
          ...
          <p>Hostel Location:<input type="text" name="hostellocation" required="required"></p>
        ...
        <div id="km">
          <?php
           $fer=mysqli_query($conect,"select * from hostel where hostel_gender='".$_SESSION['studentgender']."'")or die("Samahani sitaki-Uniache kabisa!".mysqli_error($conect));
           $hl=mysqli_num_rows($fer);
           if($hl>0){
            echo"<table><tr><th>S/N</th><th>Hostel Name</th><th>Hostel Gender</th><th>Hostel Location</th><th>Option</th></tr>";
